...
export default function ManageBrand() {
  ...
  const changeStatusBrand = (id, status) => {
    Swal.fire({
      ...
      if (result.isConfirmed) {
        ...
        ApiServices.changeStatusBrand(formData)
          .then((res) => {
            if (res.data.success) {
              toast.success(res.data.message)
...
`}
      ...
      <main className="main">
        ...
        <section id="contact" className="contact section " style={{marginTop:"7vh"}}>
            ...
            <div className="container my-4 py-4" style={{ backgroundColor: "#f4f6f9", borderRadius: "12px" }}>
              ...
              <div className="row mb-4">
                <div className="col-12">
                  <div className="toolbar d-flex flex-wrap justify-content-between align-items-center gap-3">
                    ...
                    <Link to="/admin/brand/add"  style={{backgroundColor:"#d19c97", color:"white", padding:"2px 10px", borderRadius:"6px", textDecoration:"none"}}>
                      Add New Brand
                    </Link>
              ...
              <div className="row g-4">
                {brandName?.map((brand, index) => (
                  <div className="col-lg-3 col-md-4 col-sm-6" key={brand._id}>
                    <div className="card brand-card shadow-sm h-100">
                      ...
                      <div className="card-body text-center">
                        ...
                        <div className="d-flex justify-content-center">
                          <Switch
                            onChange={() =>
                              changeStatusBrand(brand?._id, brand?.status)
                            }
